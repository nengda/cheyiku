package DTS.Utilities
{
	...
	{
		public static function Create(dataGrid:DataGrid, columns:Array, layoutMethod:String="auto"):Array {
		...
		private static function CreateColumn(column:Object):DataGridColumn {
		...
		private static function LabelDate(o:Object, c:DataGridColumn):String {
			if (o != null) {
